...
return [
    ...
    ErrorMessage::INVALID_CHOICE => 'Detta värde är inte ett giltigt val; förväntade värden: {{ expected_values }}.',
    ErrorMessage::INVALID_TIMESTAMP => 'Detta värde är inte ett giltigt tidsstämpel; förväntat format: {{ expected_format }}.',
