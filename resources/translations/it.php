...
return [
    ...
    ErrorMessage::MUST_BE_BOOLEAN => 'Questo valore deve essere di tipo boolean.',
    ...
    ErrorMessage::INVALID_TIMESTAMP => 'Questo valore non è un timestamp valido; formato atteso: {{ expected_format }}.',
