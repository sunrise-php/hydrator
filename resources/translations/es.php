...
return [
    ...
    ErrorMessage::MUST_BE_INTEGER => 'Este valor debe ser del tipo integer.',
    ...
    ErrorMessage::MUST_BE_ARRAY => 'Este valor debe ser del tipo array.',
    ...
    ErrorMessage::INVALID_DATE_INTERVAL => 'Este valor no es un intervalo de fecha válido.',
